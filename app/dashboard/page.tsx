...
export default function DashboardPage() {
    ...
    const handleAddExpense = (productName: string, price: number, quantity: number, unit: BazarUnit, dateStr: string, notes: string) => {
        ...
        const newEntry: MockBazarEntry = {
            ...
            user: MOCK_USERS[0], // Assume currently logged-in user is Ahmed Hassan
        };
        ...
        <div className="min-h-screen bg-[#1a0e07] text-[#f5ede2] flex font-sans overflow-hidden">
            ...
            <aside className="w-80 bg-[#251508] border-r border-[rgba(232,160,32,0.15)] flex flex-col shrink-0">
                ...
                <div className="p-4 border-t border-[rgba(232,160,32,0.1)] flex items-center gap-3">
                    ...
                    <button className="p-2 text-muted-foreground hover:text-destructive rounded-lg hover:bg-destructive/10 transition-colors cursor-pointer">
            ...
            <main className="flex-1 flex flex-col min-w-0 relative">
                ...
                <header className="h-20 border-b border-[rgba(232,160,32,0.1)] px-8 flex items-center justify-between shrink-0 bg-[#251508]/30">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button onClick={() => setShowAddExpense(true)} className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground text-sm font-semibold rounded-xl transition-all hover:bg-accent cursor-pointer shadow-md shadow-primary/20">
                            <Plus className="w-4 h-4" /> Add Expense
                        </button>
                        <button onClick={() => setShowAddBill(true)} className="flex items-center gap-2 px-4 py-2 border border-accent text-accent text-sm font-semibold rounded-xl transition-all hover:bg-accent/10 cursor-pointer">
                                        ...
                                        <div className="lg:col-span-2 bg-[#251508]/50 border border-[rgba(232,160,32,0.15)] rounded-2xl p-6 flex flex-col">
                                            ...
                                            <div className="flex-1 overflow-y-auto space-y-4">
                                                {calculations.memberSplits.map((s) => {
                                                    ...
                                                    return (
                                                        <div key={s.user.id} className="flex items-center justify-between p-4 rounded-xl border border-[rgba(232,160,32,0.08)] bg-card">
                                                            ...
                                                            <div className="text-right">
                                                                ...
                                                                <p className="text-[9px] text-muted-foreground">{isPositive ? "Owed to them" : "They owe"}</p>
                                                            </div>
                                                        </div>
                                                    );
                                                })}
                                            ...
                                            <div className="flex-1 overflow-y-auto space-y-3">
                                                {calculations.settlements.length === 0 ? (
                                                    <div className="h-full flex flex-col items-center justify-center text-center text-muted-foreground py-10">
                                                        ...
                                                        <p className="text-xs">All accounts are perfectly split and settled!</p>
                                                    </div>
                                                ) : (
                                                    calculations.settlements.map((s, idx) => (
                                                        <div key={idx} className="p-4 rounded-xl border border-dashed border-primary/20 bg-primary/5 flex flex-col gap-2">
                                                            ...
                                                            <div className="text-lg font-bold text-primary font-mono text-center">{fmtFull(s.amount)}</div>
                                                        </div>
                                                    ))
                                                )}
                                            </div>
                                ...
                                <div className="flex-1 flex flex-col gap-4 min-h-0 bg-[#251508]/50 border border-[rgba(232,160,32,0.15)] rounded-2xl p-6">
                                    ...
                                    <div className="flex items-center justify-between gap-4 shrink-0">
                                        <div className="relative w-80">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-2 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none text-[#f5ede2]"
                                            />
                                        </div>

                                        <div className="flex gap-2 p-0.5 border border-border rounded-xl bg-card">
                                    ...
                                    <div className="flex-1 overflow-auto rounded-xl border border-[rgba(232,160,32,0.1)]">
                                        <table className="w-full border-collapse text-left text-sm">
                                            ...
                                            <tbody className="divide-y divide-[rgba(232,160,32,0.06)] bg-card/20">
                                                {entries
                                                    .filter((e) => {
                                                    ...
                                                    .map((b) => {
                                                        ...
                                                        return (
                                                            <tr key={b.id} className="hover:bg-accent/5 transition-colors">
                                                                <td className="p-4">
                                                                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold font-mono" style={{ background: `${meta.color}15`, color: meta.color, border: `1px solid ${meta.color}30` }}>
                                                                        {meta.icon}
                                                                        {meta.label}
                                                                    </span>
                                                                </td>
                                                                ...
                                                                <td className="p-4 text-center">
                                                                    <button onClick={() => handleDeleteBill(b.id)} className="p-1.5 text-muted-foreground hover:text-destructive rounded-lg hover:bg-destructive/10 transition-colors cursor-pointer">
                                                                        <X className="w-3.5 h-3.5" />
                                                                    </button>
                                                                </td>
                                                            </tr>
              ...
              ────────────────────────────────────────────────────────────────── */}
                            {tab === "settings" && (
                                <div className="max-w-2xl bg-[#251508]/50 border border-[rgba(232,160,32,0.15)] rounded-2xl p-8 flex flex-col gap-6">
                                    <h3 className="text-lg font-bold" style={{ fontFamily: "'Tiro Devanagari Hindi', serif" }}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            <input type="text" defaultValue="Sabzi Mandi Group" className="px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl outline-none font-sans" />
                                        </div>
                                        <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="flex flex-col gap-2 mt-4">
                                        <div className="flex items-center justify-between p-4 rounded-xl border border-[rgba(232,160,32,0.1)] bg-card">
                                            <div>
                                    ...
                                    <button className="px-6 py-3.5 bg-primary text-primary-foreground font-bold rounded-xl self-start transition-all hover:bg-accent cursor-pointer">Save Setup</button>
                                </div>
                            )}
                        </motion.div>
                    </AnimatePresence>
...
function StatCard({ title, value, subtitle, color, isCount = false }: { title: string; value: number; subtitle: string; color: string; isCount?: boolean }) {
    return (
        <div className="bg-[#251508]/50 border border-[rgba(232,160,32,0.15)] rounded-2xl p-6 flex flex-col gap-2 relative overflow-hidden" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.3)" }}>
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest font-mono">{title}</p>
            <p className={`text-3xl font-extrabold ${color} font-mono mt-1`}>{isCount ? value.toLocaleString() : fmt(value)}</p>
            <p className="text-[10px] text-muted-foreground" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                {subtitle}
            </p>
        </div>
    );
...
function AvatarCircle({ name, id }: { name: string; id: string }) {
    return (
        <div className="w-6 h-6 rounded-full flex items-center justify-center font-bold text-[9px] text-[#f5ede2] shrink-0" style={{ background: avatarColor(id) }}>
            {initials(name)}
        </div>
    );
}
            ...
            {show && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        className="w-full max-w-lg bg-card border border-border rounded-3xl p-8 relative z-10 shadow-2xl"
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
                ...
                <input type="text" value={product} onChange={(e) => setProduct(e.target.value)} required placeholder="e.g. Rice, Hilsha Fish, Onion" className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none" />
            </div>
            <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider font-mono">Price (৳)</label>
                    <input type="number" value={price} onChange={(e) => setPrice(e.target.value)} required placeholder="0.00" className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none font-mono" />
                </div>
                <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider font-mono">Quantity</label>
                    <input type="number" step="any" value={quantity} onChange={(e) => setQuantity(e.target.value)} required placeholder="e.g. 2, 1.5" className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none font-mono" />
                </div>
            </div>
            <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2} placeholder="Add purchase details..." className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none resize-none" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                    ...
                    <select value={category} onChange={(e) => setCategory(e.target.value as BillCategory)} className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm outline-none text-foreground font-sans" style={{ colorScheme: "dark" }}>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <input type="number" value={amount} onChange={(e) => setAmount(e.target.value)} required placeholder="0.00" className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none font-mono" />
                </div>
            </div>
            <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider font-mono">Bill Title</label>
                <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} required placeholder="e.g. July House Rent, Wi-Fi Bill" className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none" />
            </div>
            <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider font-mono">Notes (optional)</label>
                <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2} placeholder="Add billing details..." className="w-full px-4 py-3 bg-[#2e1a0a] border border-border rounded-xl text-sm placeholder:text-muted-foreground outline-none resize-none" />
            </div>
            <div className="flex gap-3 mt-4">
                <button type="button" onClick={onClose} className="flex-1 py-3 border border-border text-foreground font-bold rounded-xl transition-all hover:bg-secondary cursor-pointer">
                    Cancel
...
// Local helper lists & colors to keep file independent and fast
