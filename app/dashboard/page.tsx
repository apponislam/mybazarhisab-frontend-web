...
import {
  ...
  Search, Calendar, Weight, Hash, AlignLeft, CheckCircle, TrendingUp, X,
  LogOut, Shield, MapPin, User, ChevronRight, AlertTriangle, Flame, Wifi,
  Zap, Droplets, Sparkles, Wrench, CreditCard, Smartphone, Heart, GraduationCap, Tv, Shirt, Banknote, Scissors, Gift, MoreHorizontal
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a0e07] text-[#f5ede2] flex font-sans overflow-hidden">
      ...
      {/* ─── LEFT SIDEBAR ──────────────────────────────────────────────────────── */}
      <aside className="w-80 bg-[#251508] border-r border-[rgba(232,160,32,0.15)] flex flex-col flex-shrink-0">
