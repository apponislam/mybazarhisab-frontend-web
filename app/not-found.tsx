  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 65% 65% at 50% 50%, rgba(232,160,32,0.08) 0%, transparent 80%)" }} />
      {BG_DOTS}
      ...
      <div className="w-full max-w-md relative z-10 flex flex-col items-center text-center">
        ...
        >
          <span className="text-8xl font-black tracking-widest text-primary/20 select-none font-mono">
            404
          </span>
        ...
        >
          ...
          <Link href="/">
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-2 px-6 py-3.5 bg-primary text-primary-foreground font-semibold rounded-xl text-sm transition-all hover:bg-accent cursor-pointer shadow-lg shadow-primary/15"
            >
