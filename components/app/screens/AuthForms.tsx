                    ...
                    >
                        <FieldBox label="Email Address" focused={fE}>
                            <div className="flex items-center" onFocus={() => setFE(true)} onBlur={() => setFE(false)}>
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                            </div>
                        </FieldBox>
                        <FieldBox label="Password" focused={fP}>
                            <div className="flex items-center" onFocus={() => setFP(true)} onBlur={() => setFP(false)}>
                                ...
                                <input type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                ...
                >
                    {[
                        ...
                        <FieldBox key={field.label} label={field.label} focused={field.f}>
                            <div className="flex items-center" onFocus={() => field.sf(true)} onBlur={() => field.sf(false)}>
                                ...
                                <input type={field.type} value={field.v} onChange={(e) => field.sv(e.target.value)} required className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                            </div>
                        </FieldBox>
                    ))}
                    <FieldBox label="Password" focused={fP}>
                        <div className="flex items-center" onFocus={() => setFP(true)} onBlur={() => setFP(false)}>
                            ...
                            <input type={showPass ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 8 characters" required className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                    ...
                    <FieldBox label="Repeat Password" focused={fR} error={mismatch ? "Passwords do not match" : undefined}>
                        <div className="flex items-center" onFocus={() => setFR(true)} onBlur={() => setFR(false)}>
                            ...
                            <input type={showRepeat ? "text" : "password"} value={repeat} onChange={(e) => setRepeat(e.target.value)} placeholder="Re-enter password" required className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                ...
                >
                    <FieldBox label="Email Address" focused={f}>
                        <div className="flex items-center" onFocus={() => setF(true)} onBlur={() => setF(false)}>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" required autoFocus className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                        </div>
                    </FieldBox>
                    ...
                    <div className="flex flex-col gap-4">
                        <FieldBox label="New Password" focused={fn}>
                            <div className="flex items-center" onFocus={() => setFn(true)} onBlur={() => setFn(false)}>
                                ...
                                <input type={sn ? "text" : "password"} value={np} onChange={(e) => setNp(e.target.value)} placeholder="Min. 8 characters" autoFocus className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
                        ...
                        <FieldBox label="Repeat Password" focused={fr} error={mm ? "Passwords do not match" : undefined}>
                            <div className="flex items-center" onFocus={() => setFr(true)} onBlur={() => setFr(false)}>
                                ...
                                <input type={sr ? "text" : "password"} value={rp} onChange={(e) => setRp(e.target.value)} placeholder="Re-enter password" className="flex-1 px-3 py-3.5 bg-transparent text-sm outline-none" style={{ fontFamily: "'DM Sans', sans-serif" }} />
