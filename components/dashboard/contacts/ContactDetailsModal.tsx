                        ...
                        {isLoading ? (
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <p className="px-4 py-2.5 bg-[#1a0e07] border border-border rounded-xl text-sm font-semibold text-foreground">
                                        {contact.subject}
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="px-4 py-3 bg-[#1a0e07] border border-border rounded-xl text-sm text-foreground leading-relaxed whitespace-pre-wrap">
                                        {contact.message}
                                    </div>
                                </div>
                                ...
                                {contact.isReplied && contact.replyMessage && (
                                    <div className="flex flex-col gap-1.5 pt-2 border-t border-border">
                                        ...
                                        <div className="px-4 py-3 bg-green-500/10 border border-green-500/20 rounded-xl text-sm text-foreground leading-relaxed whitespace-pre-wrap font-mono text-xs">
