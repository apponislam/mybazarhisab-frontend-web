                    ...
                    {isLoading ? (
                            ...
                            <td colSpan={5} className="p-12 text-center text-muted-foreground">
                                <div className="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        {searchTerm ? "Try searching for a different keyword." : "Click 'Add Product' to create your first product."}
                                    </p>
                                </div>
                            </td>
                        </tr>
                        ...
                        products.map((product) => (
                            <tr key={product._id} className="hover:bg-primary/5 transition-colors group">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                {product.isEdited && (
                                                    <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-accent/15 text-accent border border-accent/20">
                                                        Edited
                                                    </span>
                                                )}
                                            </div>
                                ...
                                <td className="p-4 text-center">
                                    {product.isDeleted ? (
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono bg-gray-500/20 text-gray-400 border border-gray-500/30">
                                            Deleted
                                        </span>
                                        ...
                                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-mono bg-yellow-500/15 text-yellow-400 border border-yellow-500/30">
                                            Inactive
                                        </span>
                                    )}
                                </td>
