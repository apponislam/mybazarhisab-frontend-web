    ...
    <ScreenShell scrollable>
      <div className="flex flex-col px-6 pt-12 pb-8 relative">
        ...
        <div className="flex items-center gap-3 mb-7 flex-shrink-0">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground" style={{ fontFamily: "'Tiro Devanagari Hindi', serif" }}>Add Bill</h2>
            <p className="text-xs text-muted-foreground" style={{ fontFamily: "'DM Sans', sans-serif" }}>Utility or recurring expense</p>
          </div>
        </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
            ...
            <motion.div initial={{ y: 60 }} animate={{ y: 0 }} transition={{ type: "spring", damping: 28 }}
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => setShowCatPicker(false)} className="w-7 h-7 rounded-full bg-secondary flex items-center justify-center cursor-pointer"><X className="w-3.5 h-3.5 text-muted-foreground" /></button>
              </div>
