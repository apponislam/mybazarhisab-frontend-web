    ...
    <ScreenShell scrollable>
      <div className="flex flex-col px-6 pt-12 pb-8">
        ...
        <div className="flex items-center gap-3 mb-7">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground" style={{ fontFamily: "'Tiro Devanagari Hindi', serif" }}>Add Expense</h2>
            <p className="text-xs text-muted-foreground" style={{ fontFamily: "'DM Sans', sans-serif" }}>Bazar purchase entry</p>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="flex gap-2">
              {(["KG", "PIECE", "GM"] as BazarUnit[]).map(u => (
                <button key={u} type="button" onClick={() => setUnit(u)} className="flex-1 py-3 rounded-xl border text-sm font-semibold transition-all cursor-pointer"
