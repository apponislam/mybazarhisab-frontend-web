...
export function BillDetailScreen({ bill, onBack, onEdit, onDelete }: {
    ...
    <ScreenShell scrollable>
      <div className="flex flex-col px-6 pt-12 pb-8">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }}
          ...
          <span className="text-xs px-2 py-1 rounded-lg font-semibold mb-2 inline-block font-mono"
          ...
          <p className="text-4xl font-bold font-mono" style={{ color: meta.color }}>{fmtFull(bill.amount)}</p>
        </motion.div>
