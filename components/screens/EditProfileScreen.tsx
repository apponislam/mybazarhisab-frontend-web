          ...
          <button type="button" onClick={() => fileRef.current?.click()} className="relative group cursor-pointer">
            <div className="w-24 h-24 rounded-full border-2 border-dashed border-primary/40 group-hover:border-primary/80 transition-all overflow-hidden"
              ...
              {photo
                ...
                : <div className="w-full h-full flex items-center justify-center text-2xl font-bold text-white font-mono" style={{ background: avatarColor(me.id) }}>{initials(me.name)}</div>
              }
            </div>
