        ...
        <div className="min-h-screen w-full bg-[#130a04] text-[#f5ede2] flex flex-col font-sans">
            ...
            <main className="flex-1 container mx-auto px-6 py-12 max-w-3xl">
                ...
                <div className="space-y-6 text-sm text-foreground/80 leading-relaxed font-sans border-t border-border pt-6">
                    <p>Welcome to My Bazar Hisab. By accessing or using our website and mobile application, you agree to be bound by these Terms & Conditions. Please read them carefully before using our service.</p>

                    <h2 className="text-lg font-bold text-foreground pt-4 mb-2">1. Account Terms</h2>
                    <p>You must provide accurate and complete registration information. You are responsible for keeping your login credentials and group access codes confidential. You are responsible for all activity occurring under your account.</p>

                    <h2 className="text-lg font-bold text-foreground pt-4 mb-2">2. Acceptable Use</h2>
                    <p>You agree to use My Bazar Hisab only for lawful household expense tracking and budget recording. You must not:</p>
                    ...
                    <p>My Bazar Hisab enables multiple users to join a shared group ledger. All members of a group will be able to see expenses logged within that group. The group owner and members are responsible for managing member access.</p>

                    <h2 className="text-lg font-bold text-foreground pt-4 mb-2">4. Calculation & Settlement Disclaimer</h2>
                    <p>My Bazar Hisab provides tools for logging expenses and calculating shared balances. We provide mathematical accuracy based on the figures you input. However, actual monetary payments or cash settlements take place off-platform between household members.</p>

                    <h2 className="text-lg font-bold text-foreground pt-4 mb-2">5. Service Availability & Updates</h2>
                    <p>We strive to keep the service running smoothly, but we do not guarantee uninterrupted access. We reserve the right to modify, update, or temporarily suspend parts of the service for routine maintenance or improvements.</p>
