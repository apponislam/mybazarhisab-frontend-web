...
export const baseApi = createApi({
    ...
    tagTypes: ["User", "BoostPack", "Settings", "IdentityVerification", "Category", "Dashboard", "Order", "Activity", "Dispute", "Payment", "Report", "BazarEntry", "BazarEntryStats", "Bill", "BillStats", "Product", "Group", "Notification", "Feedback", "Faq", "Policy", "Review", "Contact", "Visitor"],
    endpoints: () => ({}),
});
